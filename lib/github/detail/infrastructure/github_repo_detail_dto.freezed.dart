...
abstract class $GithubRepoDetailDTOCopyWith<$Res> {
  ...
  $Res call({String html, String fullName, bool starred});
}
...
class _$_GithubRepoDetailDTO extends _GithubRepoDetailDTO {
  const _$_GithubRepoDetailDTO(
      {required this.html, required this.fullName, required this.starred})
      : super._();
  ...
  @override
  String toString() {
    return 'GithubRepoDetailDTO(html: $html, fullName: $fullName, starred: $starred)';
  }
