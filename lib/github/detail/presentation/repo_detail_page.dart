...
class _RepoDetailPageState extends ConsumerState<RepoDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<RepoDetailState>(repoDetailNotifierProvider,
        (previousState, state) {
      state.maybeWhen(
          orElse: () {},
          ...
          loadSuccess: (_) {
            if (_.repoDetail.entity == null) {
              return NoResultDisplay(
                  message:
                      "These are approximately all the details we could find about this page right now");
            } else {
              return WebView(
                ...
                navigationDelegate: (navigation) {
                  if (navigation.url.startsWith('data:')) {
                    ...
                    url_launcher.launchUrlString(navigation.url);
