...
class RepoDetailState with _$RepoDetailState {
  ...
  const factory RepoDetailState.initial(
      {@Default(false) bool hasStarredStatusChanged}) = _Initial;
  const factory RepoDetailState.loadInProgress(
      {@Default(false) bool hasStarredStatusChanged}) = _LoadInProgess;
  ...
  const factory RepoDetailState.failure(GithubFailure failure,
      {@Default(false) bool hasStarredStatusChanged}) = _LoadFailure;
}

class RepoDetailNotifier extends StateNotifier<RepoDetailState> {
  final RepoDetailRepository _repository;

  RepoDetailNotifier(this._repository) : super(RepoDetailState.initial());
