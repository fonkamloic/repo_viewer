...
import 'package:repo_viewer/github/repos/searched_repos/application/search_repos_notifier.dart';
...
final starredReposRemoteServicePorvider = Provider((ref) =>
...
final starredReposRepositoryProvider = Provider((ref) => StarredReposRepository(
    ref.watch(starredReposRemoteServicePorvider),
...
final searchedReposRemoteServicePorvider = Provider((ref) =>
    SearchedReposRemoteService(
        ref.watch(dioProvider), ref.watch(githubHeadersCacheProvider)));

final searchedReposRepositoryProvider = Provider((ref) =>
    SearchedReposRepository(ref.watch(searchedReposRemoteServicePorvider)));
...
final repoDetailLocalServiceProvider = Provider((ref) => RepoDetailLocalService(
    ref.watch(sembastProvider), ref.watch(githubHeadersCacheProvider)));
